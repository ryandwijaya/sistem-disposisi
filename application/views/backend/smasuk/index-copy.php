				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center" style="width: 300px;">
							<a href="#" class="btn btn-warning" title="Edit"><i class="zmdi zmdi-edit"></i></a> 
							...
							<a href="<?php echo base_url() ?>surat/delete/<?php echo $val['surat_id'] ?>" onclick="return confirm('Yakin ingin menghapus data ini?')" class="btn btn-danger"><i class="zmdi zmdi-delete" title="Hapus"></i></a>
                                    ...
                                    <?php }elseif($this->session->userdata('session_jabatan')==$val['surat_lajur_tujuan'] && $this->session->userdata('session_status_pegawai')=='fungsional'){ ?>
                                          

                                          
                                          <!-- buatkan fungsi untuk cek lajur dengan id ini          -->
                                          
                                          <?php $lajur = $this->SMasukModel->getLajurBySurat($val['surat_id']) ?>
                                          <?php if (count($lajur)>0){ ?>
