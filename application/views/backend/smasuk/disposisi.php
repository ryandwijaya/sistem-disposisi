            ...
            <div class="col-md-12">
                ...
                <div class="print float-right">
                    <?php if ($surat['surat_acc_pimpinan'] == 1) { ?>
                        <button class="btn btn-success" onclick="printContent('print')"><i class="zmdi zmdi-print"></i>
                            Cetak
                        </button>

                    <?php } else { ?>
                        <button class="btn btn-default"
                                onclick="return alert('Surat belum bisa di print karena belum di acc Pimpinan')"><i
                                    class="zmdi zmdi-print"></i> Cetak
                        </button>
                    <?php } ?>
            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td style="width: 20%;" class="text-center"><b>Tgl.</b></td>
                    </tr>
                    <tr style="height: 200px;">
                        ...
                        <td style="width: 15%;">
                            <br>
                            <?php
                            if ($surat['surat_lajur_tujuan']!=''){

                                echo "<span style='font-size: 11px' class='text-success'>sudah didispposisi</span>";
                            }else{
                                echo "<span style='font-size: 11px' class='text-danger '>belum didisposisi</span>";
                            }
                            ?>
                            <br><br>
                            <br>
                            <?php
                            if ($surat['surat_tujuan2']!=''){
                        ...
                        <td style="width: 20%;" class="text-center">
                            ...
                            if ($surat['surat_lajur_tujuan']!=''){
                                ...
                                echo date_indo($surat['surat_paraf_pimpinan']);
                            }else{
                                echo "<span style='font-size: 11px' class='text-danger '>belum didisposisi</span>";
                            }
                            ?>
                            ...
                            if ($surat['surat_tujuan2']!=''){
                                ...
                                echo date_indo($surat['surat_paraf_kabag']);
                            }else{
                                echo "<span style='font-size: 11px' class='text-danger '>belum didisposisi</span>";
                            }
                            ?>
                            ...
                            if ($surat['surat_ket_kasubag']!=''){
                                ...
                                echo date_indo($surat['surat_paraf_kasubbag']);
                            }else{
                                echo "<span style='font-size: 11px' class='text-danger '>belum didisposisi</span>";
                            }
                            ?>
